...
function Days(props) {
  ...
  var showFixedNumberOfWeeks = props.showFixedNumberOfWeeks,
      ...
      hideDatesOlderThanMin = props.hideDatesOlderThanMin,
      minDate = props.minDate,
      otherProps = _objectWithoutProperties(props, ["showFixedNumberOfWeeks", "showNeighboringMonth", "hideDatesOlderThanMin", "minDate"]);

  var year = (0, _dateUtils.getYear)(activeStartDate);
  var monthIndex = (0, _dateUtils.getMonth)(activeStartDate);
  var minMonthYear = minDate ? (0, _dateUtils.getYear)(minDate) : -1;
  var minMonthIndex = minDate ? (0, _dateUtils.getMonth)(minDate) : -1;
  ...
  var start = function () {
    if (hideDatesOlderThanMin && minMonthYear === year && minMonthIndex === monthIndex) {
      ...
      // the min date's week.
      return minDate.getDate() - (0, _dates.getDayOfWeek)(minDate, calendarType);
    }
